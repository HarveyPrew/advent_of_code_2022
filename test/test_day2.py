from advent_of_code_2022.day_2 import (point_receiver, point_receiver_part_2,
                                       outcome_converter)
...
def test_point_receiver_part_2_is_correct_test():
    score = point_receiver_part_2('input_day_2_test.txt')
    assert score == 12


def test_point_receiver_part_2_is_correct():
    score = point_receiver_part_2('input_day_2.txt')
    assert score == 10334
